...
impl fmt::Display for TrieError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            TrieError::InvalidData => f.write_str("trie error: invali data"),
            TrieError::InvalidStateRoot => f.write_str("trie error: invali state root"),
            TrieError::InvalidProof => f.write_str("trie error: invali proof"),
        }
    }
}
